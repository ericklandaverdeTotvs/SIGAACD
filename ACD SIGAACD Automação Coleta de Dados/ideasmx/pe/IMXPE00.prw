...
User Function MA410MNU()
	...
	//Descripción: Informe
	aadd(aRotina,{'Imprimir', 'U_EFAT008R()', 0 , 6,0,NIL})
Return

//Autor: Cuauhtémoc Olvera
//Fecha de creación: 2015-05-06
//Fecha de revisión 2: 2016-03-013
//Versión: 2
...
//Fecha de revisión:
//Versión: 1
//Descripción: Crea estructura ACD.
User Function IMXPE00A()
...
//Fecha de revisión:
//Versión: 1
//Descripción: Elimina estructura ACD.
User Function IMXPE00B()
	Local	aSC7	:=	SC7->(GetArea())
	Local	cSerie	:=	"RX"
	U_IMX46PEB(cSerie, SC7->C7_NUM)
	restArea(aSC7)
...
User Function IMX46PEA(cSerie, cFuncion)
	...
	Do While &(cCampo1) == xFilial(cTabla) .And. &(cCampo2) == cFolioOrigen
		...
		SZ2->Z2_LOTE1	:=	criaVar("Z2_LOTE1")
		SZ2->Z2_LOC1	:=	criaVar("Z2_LOC1")
		MsUnlock("SZ2")
		&(cTabla)->(dbSkip())
	End
Return
